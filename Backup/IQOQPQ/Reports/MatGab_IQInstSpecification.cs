...
public class IQInstSpecification : ReportClass
{

	public IQInstSpecification()
	{
		base.New();
	}

	public override string ResourceName {
		get { return "IQInstSpecification.rpt"; }
			//Do nothing
		set { }
	}
...
public class CachedIQInstSpecification : Component, ICachedReport
{

	public CachedIQInstSpecification()
	{
		base.New();
	}
	...
	{
		IQInstSpecification rpt = new IQInstSpecification();
		rpt.Site = this.Site;
		return rpt;
	}
