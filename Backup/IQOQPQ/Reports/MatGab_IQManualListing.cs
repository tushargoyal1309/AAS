...
public class IQManualListing : ReportClass
{

	public IQManualListing()
	{
		base.New();
	}

	public override string ResourceName {
		get { return "IQManualListing.rpt"; }
			//Do nothing
		set { }
	}
...
public class CachedIQManualListing : Component, ICachedReport
{

	public CachedIQManualListing()
	{
		base.New();
	}
	...
	{
		IQManualListing rpt = new IQManualListing();
		rpt.Site = this.Site;
		return rpt;
	}
