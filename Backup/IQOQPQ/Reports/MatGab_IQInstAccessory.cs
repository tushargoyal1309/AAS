...
public class IQInstAccessory : ReportClass
{

	public IQInstAccessory()
	{
		base.New();
	}

	public override string ResourceName {
		get { return "IQInstAccessory.rpt"; }
			//Do nothing
		set { }
	}
...
public class CachedIQInstAccessory : Component, ICachedReport
{

	public CachedIQInstAccessory()
	{
		base.New();
	}
	...
	{
		IQInstAccessory rpt = new IQInstAccessory();
		rpt.Site = this.Site;
		return rpt;
	}
