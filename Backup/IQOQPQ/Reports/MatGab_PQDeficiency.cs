...
public class PQDeficiency : ReportClass
{
...
public class CachedPQDeficiency : Component, ICachedReport
{

	public CachedPQDeficiency()
	{
		base.New();
	}
	...
	{
		PQDeficiency rpt = new PQDeficiency();
		rpt.Site = this.Site;
		return rpt;
	}
