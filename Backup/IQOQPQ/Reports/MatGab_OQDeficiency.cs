...
public class OQDeficiency : ReportClass
{
...
public class CachedOQDeficiency : Component, ICachedReport
{

	public CachedOQDeficiency()
	{
		base.New();
	}
	...
	{
		OQDeficiency rpt = new OQDeficiency();
		rpt.Site = this.Site;
		return rpt;
	}
