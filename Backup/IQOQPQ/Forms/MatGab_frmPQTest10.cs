...
public class frmPQTest10 : System.Windows.Forms.Form
{
	...
	{
		System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmPQTest10));
		...
		this.lblAttachment.Text = "Attachment IX";
		//
		//lblMethod
		//
		...
		this.lblMethod.Text = "Method            :  Flame Photometric detector  :";
		//
		//lblPurpose
		//
		...
		this.Panel1.Size = new System.Drawing.Size(344, 510);
		...
		this.Panel2.Size = new System.Drawing.Size(342, 32);
...
frmPQTest2_Closing(object sender, System.ComponentModel.CancelEventArgs e)
	...
	private bool funcDisplayPQTest1()
	{
		...
		try {
			...
			mobjTmpDt = gobjDataAccess.funcGetPQTest9Records();
	...
	public bool funcSavePQTest1Remarks()
	{
		...
		try {
			...
			for (temp_cnt = 0; temp_cnt <= objDataTable.Rows.Count - 1; temp_cnt++) {
				...
				status = gobjDataAccess.funcUpdatePQTest9Records(dblRT, dblPeakArea, strValidationTestID);
				if (!(status)) {
	...
	private void subDisplayMethodInfo()
	{
		...
		try {
			...
			objDataRow = objCADataTable.NewRow();
			objDataRow("Name") = "3. Flow Rate        : N2 - 30 ml/min, H2 - 110 ml/min, Air1 - 40 ml/min, Air2 - 160 ml/min for capillary column flow, refer to the column manufacturer's instruction.";
			objCADataTable.Rows.Add(objDataRow);

			objDataRow = objCADataTable.NewRow();
			objDataRow("Name") = "4. Detector         : FPD.";
			objCADataTable.Rows.Add(objDataRow);
			...
			objDataRow = objCADataTable.NewRow();
			objDataRow("Name") = "6 Temperature       : Oven-80 �C., Injector-150 �C., Detector-170 �C.";
			objCADataTable.Rows.Add(objDataRow);

			objDataRow = objCADataTable.NewRow();
			objDataRow("Name") = "7. Range            : 5.40(approx. -550 volt PMT voltage) on FPD power supply unit.";
			objCADataTable.Rows.Add(objDataRow);

			objDataRow = objCADataTable.NewRow();
			objDataRow("Name") = "8. FPD Amplifier Range : x1.";
			objCADataTable.Rows.Add(objDataRow);

			objDataRow = objCADataTable.NewRow();
			objDataRow("Name") = "9. Attenuation      : x16.";
			objCADataTable.Rows.Add(objDataRow);
			...
			objDataRow = objCADataTable.NewRow();
			objDataRow("Name") = "B. Preparation of standard solution : Make 1.0 ppm Carbon Disulfied solution in Toluene.";
			objCADataTable.Rows.Add(objDataRow);

			objDataRow = objCADataTable.NewRow();
			objDataRow("Name") = "C. Inject 1.0 Micro liter of std. solution 5 replicates and record the chromatograms.";
			objCADataTable.Rows.Add(objDataRow);
