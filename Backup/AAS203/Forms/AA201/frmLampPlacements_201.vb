...
Public Class frmLampPlacements_201
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmLampPlacements_201))
        ...
        Me.Name = "frmLampPlacements_201"
        Me.ShowInTaskbar = False
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Lamp Placements AA 201"
...
#Region " Form Events "
    ...
    Private Sub frmLampPlacements_201_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        '=====================================================================
        ' Procedure Name        : frmLampPlacements_201_Load
        ...
        Try
            ...
            If gstructSettings.NewModelName = False Then
                Me.Text = "Lamp Placements AA 201"
            Else
                Me.Text = "Lamp Placements AA 301"
            End If
            '--4.85  14.04.09
...
#Region " Functions "
    ...
    Private Function funcInitialise() As Boolean
        ...
        Try
            ...
            Return True 'gobjCommProtocol.gFuncTurret_Home()
    ...
    Private Function funcInitiliaze_Lamps() As Boolean
        ...
        Try
            For intCount = 1 To gobjClsAAS203.funcGetMaxLamp()
                'Call gfuncGet_Lamp_Parameters(objLampPar, intCount)
                Call gfuncGet_Lamp_Parameters(objLampPar, intCount - 1) 'Modify by Pankaj on 30 May 07
