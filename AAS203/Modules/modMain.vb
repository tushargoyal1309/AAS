...
Module modMain
    Public Sub main()
        ...
        Try
            ...
            If gstructSettings.Enable21CFR = True Then
                ''check for 21 CFR
                If funcValidateAdminExists() = False Then
                    Dim objfrmFirstInstallation As New frmFirstTimeInstallation
                    objfrmFirstInstallation.ShowDialog()
                    Application.DoEvents()
                Else
    ...
    Private Function funcValidateAdminExists() As Boolean
        '=====================================================================
        ...
        Try
            ...
            str_sql = "SELECT Count(*) AS CountOfUserName" _
                       & " FROM Users "
