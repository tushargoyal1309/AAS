...
#Region " Windows Form Designer generated code "
    ...
    Public Sub New()
        ...
        Try
            ...
            ' mobjfrmMethod.Show()
            'mobjfrmMethod.BringToFront() --Manoj
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'mnuAdministration
        '
        Me.mnuAdministration.Items.AddRange(New NETXP.Controls.Bars.CommandBarItem() {Me.mnuAddUser, Me.mnuUserPermissions, Me.CommandBarSeparatorItem5, Me.mnuActivityLog, Me.mnuChangePassword, Me.mnu21CFR})
        ...
        Me.mnuActivityLog.Text = "&Audit Trail"
        '
        'mnuChangePassword
        '
        ...
        Me.StatusBarPanelDate.Name = "StatusBarPanelDate"
    ...
    Private Sub frmMDIMain_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
           ...
           gstructSettings.AppMode = EnumAppMode.FullVersion_203 Or gstructSettings.AppMode = EnumAppMode.DemoMode Then
            ...
            mobjfrmMethod.Focus()
            mobjfrmMethod.Show()
            mobjfrmMethod.Width = Me.Width 'Manoj
            mobjfrmMethod.Height = Me.Height 'Manoj
        ...
        Try
            ...
            If Not IsNothing(mobjfrmAnalysis) Then
                ...
                If (retval = 2) Then
                    ...
                    mobjfrmAnalysis.Show() '-- Manoj
                    '---bring analysis from in front
                    mobjfrmAnalysis.BringToFront() '--Manoj
                    Application.DoEvents()
