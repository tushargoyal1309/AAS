...
#Region " Public Shared Functions "
    ...
    Public Shared Function funcExportData(ByVal strReportNameIn As String, ByVal dsText As DataSet, _
        ...
        Try
            ...
            objSaveFileDlg.Filter = "Text File (*.Pdf)|*.Pdf|All Files (*.*)|*.*"

            If objSaveFileDlg.ShowDialog = DialogResult.OK Then
                objDatafileExportCryReport.ExportToDisk(CrystalDecisions.[Shared].ExportFormatType.PortableDocFormat, objSaveFileDlg.FileName)
            End If
