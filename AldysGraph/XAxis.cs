...
////			else
		...
		public double TransformRev( float x )
		{
			...
			if ( this.isReverse  )
				return (float) ( this.maxScale - ( this.maxScale - this.minScale ) *ratio );
			else 
