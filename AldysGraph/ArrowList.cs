...
namespace AldysGraph
{
	...
	public class ArrowItem : ICloneable
	{
		...
		protected void Init()
		{
			this.color = Defaults.Arrow.Color;
			this.size = Defaults.Arrow.Size;
			this.penWidth = Defaults.Arrow.PenWidth;
			this.x1 = 0F;
			this.y1 = 0F;
			this.x2 = 0.2F;
			this.y2 = 0.2F;
			isArrowHead = Defaults.Arrow.IsArrowHead;
			coordinateFrame = Defaults.Arrow.CoordFrame;
		}
