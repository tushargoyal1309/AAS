...
Public Class PQCompleteAcceptBy
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IQOQPQ.PQCompleteAcceptBy.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPQCompleteAcceptBy
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PQCompleteAcceptBy = New PQCompleteAcceptBy()
        rpt.Site = Me.Site
        Return rpt
    End Function
