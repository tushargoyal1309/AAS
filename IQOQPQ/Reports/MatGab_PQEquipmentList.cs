...
public class PQEquipmentList : ReportClass
{

	public PQEquipmentList()
	{
		base.New();
	}

	public override string ResourceName {
		get { return "PQEquipmentList.rpt"; }
			//Do nothing
		set { }
	}
...
public class CachedPQEquipmentList : Component, ICachedReport
{

	public CachedPQEquipmentList()
	{
		base.New();
	}
	...
	{
		PQEquipmentList rpt = new PQEquipmentList();
		rpt.Site = this.Site;
		return rpt;
	}
