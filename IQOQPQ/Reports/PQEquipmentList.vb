...
Public Class PQEquipmentList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IQOQPQ.PQEquipmentList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPQEquipmentList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PQEquipmentList = New PQEquipmentList()
        rpt.Site = Me.Site
        Return rpt
    End Function
