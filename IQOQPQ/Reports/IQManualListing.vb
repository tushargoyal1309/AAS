...
Public Class IQManualListing
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IQOQPQ.IQManualListing.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedIQManualListing
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As IQManualListing = New IQManualListing()
        rpt.Site = Me.Site
        Return rpt
    End Function
