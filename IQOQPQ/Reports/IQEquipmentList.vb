...
Public Class IQEquipmentList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IQOQPQ.IQEquipmentList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedIQEquipmentList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As IQEquipmentList = New IQEquipmentList()
        rpt.Site = Me.Site
        Return rpt
    End Function
