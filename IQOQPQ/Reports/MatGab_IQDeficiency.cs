...
public class IQDeficiency : ReportClass
{
...
public class CachedIQDeficiency : Component, ICachedReport
{

	public CachedIQDeficiency()
	{
		base.New();
	}
	...
	{
		IQDeficiency rpt = new IQDeficiency();
		rpt.Site = this.Site;
		return rpt;
	}
