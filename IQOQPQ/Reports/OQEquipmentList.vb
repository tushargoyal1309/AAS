...
Public Class OQEquipmentList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IQOQPQ.OQEquipmentList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOQEquipmentList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OQEquipmentList = New OQEquipmentList()
        rpt.Site = Me.Site
        Return rpt
    End Function
