...
public class IQEquipmentList : ReportClass
{

	public IQEquipmentList()
	{
		base.New();
	}

	public override string ResourceName {
		get { return "IQEquipmentList.rpt"; }
			//Do nothing
		set { }
	}
...
public class CachedIQEquipmentList : Component, ICachedReport
{

	public CachedIQEquipmentList()
	{
		base.New();
	}
	...
	{
		IQEquipmentList rpt = new IQEquipmentList();
		rpt.Site = this.Site;
		return rpt;
	}
