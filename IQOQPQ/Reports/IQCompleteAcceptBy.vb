...
Public Class IQCompleteAcceptBy
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IQOQPQ.IQCompleteAcceptBy.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedIQCompleteAcceptBy
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As IQCompleteAcceptBy = New IQCompleteAcceptBy()
        rpt.Site = Me.Site
        Return rpt
    End Function
