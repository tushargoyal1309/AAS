...
Public Class IQInstAccessory
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IQOQPQ.IQInstAccessory.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedIQInstAccessory
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As IQInstAccessory = New IQInstAccessory()
        rpt.Site = Me.Site
        Return rpt
    End Function
