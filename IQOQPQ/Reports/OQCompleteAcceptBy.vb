...
Public Class OQCompleteAcceptBy
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IQOQPQ.OQCompleteAcceptBy.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOQCompleteAcceptBy
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OQCompleteAcceptBy = New OQCompleteAcceptBy()
        rpt.Site = Me.Site
        Return rpt
    End Function
