...
public class OQUserTraining : ReportClass
{

	public OQUserTraining()
	{
		base.New();
	}

	public override string ResourceName {
		get { return "OQUserTraining.rpt"; }
			//Do nothing
		set { }
	}
...
public class CachedOQUserTraining : Component, ICachedReport
{

	public CachedOQUserTraining()
	{
		base.New();
	}
	...
	{
		OQUserTraining rpt = new OQUserTraining();
		rpt.Site = this.Site;
		return rpt;
	}
