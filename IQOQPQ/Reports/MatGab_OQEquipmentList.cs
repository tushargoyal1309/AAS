...
public class OQEquipmentList : ReportClass
{

	public OQEquipmentList()
	{
		base.New();
	}

	public override string ResourceName {
		get { return "OQEquipmentList.rpt"; }
			//Do nothing
		set { }
	}
...
public class CachedOQEquipmentList : Component, ICachedReport
{

	public CachedOQEquipmentList()
	{
		base.New();
	}
	...
	{
		OQEquipmentList rpt = new OQEquipmentList();
		rpt.Site = this.Site;
		return rpt;
	}
