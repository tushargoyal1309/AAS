...
Public Class OQUserTraining
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IQOQPQ.OQUserTraining.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOQUserTraining
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OQUserTraining = New OQUserTraining()
        rpt.Site = Me.Site
        Return rpt
    End Function
