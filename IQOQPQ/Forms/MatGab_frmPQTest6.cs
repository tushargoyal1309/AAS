...
public class frmPQTest6 : System.Windows.Forms.Form
{
	...
	{
		System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmPQTest6));
		...
		this.lblAttachment.Text = "Attachment V";
		//
		//lblMethod
		//
		...
		this.lblMethod.Text = "Method            :  Thermal Conductivity detector with Single and Dual Packed an" + "d with MFC Column system :";
		//
		//lblPurpose
		//
		...
		this.Panel1.Size = new System.Drawing.Size(328, 510);
...
frmPQTest2_Closing(object sender, System.ComponentModel.CancelEventArgs e)
	...
	private bool funcDisplayPQTest1()
	{
		...
		try {
			...
			mobjTmpDt = gobjDataAccess.funcGetPQTest5Records();
	...
	public bool funcSavePQTest1Remarks()
	{
		...
		try {
			...
			for (temp_cnt = 0; temp_cnt <= objDataTable.Rows.Count - 1; temp_cnt++) {
				...
				status = gobjDataAccess.funcUpdatePQTest5Records(dblRT, dblPeakArea, strValidationTestID);
				if (!(status)) {
