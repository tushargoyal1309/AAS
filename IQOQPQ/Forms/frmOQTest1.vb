...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmOQTest))
        ...
        Me.lblHeader.Size = New System.Drawing.Size(440, 18)
        ...
        Me.lblHeader2.Size = New System.Drawing.Size(528, 32)
        Me.lblHeader2.TabIndex = 14
        ...
        'lblTestName1
        '
        Me.lblTestName1.Location = New System.Drawing.Point(8, 112)
        Me.lblTestName1.Name = "lblTestName1"
        Me.lblTestName1.Size = New System.Drawing.Size(264, 18)
        Me.lblTestName1.TabIndex = 15
        Me.lblTestName1.Text = "Test Name : Instrument setup, menus, display"
        '
        'lblPurpose1
        '
        Me.lblPurpose1.Location = New System.Drawing.Point(8, 136)
        Me.lblPurpose1.Name = "lblPurpose1"
        Me.lblPurpose1.Size = New System.Drawing.Size(392, 18)
        Me.lblPurpose1.TabIndex = 16
        Me.lblPurpose1.Text = "Purpose      : Introduction and Familiarisation with routine operation."
        '
        'lblPurpose3
        '
        Me.lblPurpose3.Location = New System.Drawing.Point(8, 424)
        Me.lblPurpose3.Name = "lblPurpose3"
        Me.lblPurpose3.Size = New System.Drawing.Size(400, 18)
        Me.lblPurpose3.TabIndex = 22
        Me.lblPurpose3.Text = "Purpose      : Introduction and Familiarisation with routine operation."
        '
        'lblTestName3
        '
        Me.lblTestName3.Location = New System.Drawing.Point(8, 400)
        Me.lblTestName3.Name = "lblTestName3"
        Me.lblTestName3.Size = New System.Drawing.Size(448, 18)
        Me.lblTestName3.TabIndex = 21
        Me.lblTestName3.Text = "Test Name : Installation of HC Lamp and Acetylene or Nitrous Oxide Burner."
        '
        'lblPurpose2
        '
        Me.lblPurpose2.Location = New System.Drawing.Point(8, 288)
        Me.lblPurpose2.Name = "lblPurpose2"
        Me.lblPurpose2.Size = New System.Drawing.Size(400, 18)
        Me.lblPurpose2.TabIndex = 25
        Me.lblPurpose2.Text = "Purpose      : Introduction and Familiarisation with routine operation."
        '
        'lblTestName2
        '
        Me.lblTestName2.Location = New System.Drawing.Point(8, 264)
        Me.lblTestName2.Name = "lblTestName2"
        Me.lblTestName2.Size = New System.Drawing.Size(264, 18)
        Me.lblTestName2.TabIndex = 24
        Me.lblTestName2.Text = "Test Name : Basic Operation Procedure"
        '
        'Panel1
        '
        ...
        Me.Panel1.Size = New System.Drawing.Size(496, 560)
        ...
        Me.lblModelNo.Location = New System.Drawing.Point(192, 83)
        Me.lblModelNo.Name = "lblModelNo"
        Me.lblModelNo.Size = New System.Drawing.Size(176, 24)
        ...
        Me.Panel2.Size = New System.Drawing.Size(494, 32)
        ...
        Me.dgTest3.Location = New System.Drawing.Point(8, 448)
        Me.dgTest3.Name = "dgTest3"
        Me.dgTest3.ParentRowsVisible = False
        Me.dgTest3.ReadOnly = True
        Me.dgTest3.RowHeadersVisible = False
        Me.dgTest3.Size = New System.Drawing.Size(568, 60)
        Me.dgTest3.TabIndex = 27
        '
        'dgTest2
        '
        ...
        Me.dgTest2.Location = New System.Drawing.Point(8, 312)
        ...
        Me.ClientSize = New System.Drawing.Size(496, 560)
        Me.ControlBox = False
        ...
        Me.Name = "frmOQTest"
        Me.Text = "Operational Qualification Tests"
...
#Region " Form Events "
    Private Sub frmOQTest_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            funcInitialize()
    ...
    Private Sub frmOQTest_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
        Try
            If Not (mblnModeLockStatus) Then
                dgTest1.CurrentCell() = (New DataGridCell(dgTest1.CurrentRowIndex + 1, 0))
                If Not funcSaveOQTest1Data(ENUM_TestNos.TestNo1) Then
                ...
                If Not funcSaveOQTest1Data(ENUM_TestNos.TestNo2) Then
                    Throw New Exception("Error in Saving OQ Test Data.")
                End If
                dgTest2.TableStyles.Clear()

                dgTest3.CurrentCell() = (New DataGridCell(dgTest3.CurrentRowIndex + 1, 0))
                If Not funcSaveOQTest1Data(ENUM_TestNos.TestNo3) Then
                    Throw New Exception("Error in Saving OQ Test Data.")
                End If
...
#Region " General Private functions "
    ...
    Private Function funcGetOQTest1Records(ByVal testnos As Integer) As Boolean
        '=====================================================================
                        ...
                        If Not mobjTmpDt Is Nothing Then
                            If Not mobjTmpDt.Rows.Count = 0 Then
                                For intCount = 0 To mobjTmpDt.Rows.Count - 1
                                    ...
                                    objDataRow.Item(ConstTestName) = gfuncWordWrap(CStr(mobjTmpDt.Rows.Item(intCount).Item("OQTestName")), intCharConst) '5.4.2010
                                    objDataRow.Item(ConstObservation) = gfuncWordWrap((mobjTmpDt.Rows.Item(intCount).Item("OQObservation")), intCharConst) '5.4.2010
                        ...
                        If Not mobjTmpDt Is Nothing Then
                            If Not mobjTmpDt.Rows.Count = 0 Then
                                For intCount = 0 To mobjTmpDt.Rows.Count - 1
                                    ...
                                    objDataRow.Item(ConstTestName) = gfuncWordWrap(CStr(mobjTmpDt.Rows.Item(intCount).Item("OQTestName")), intCharConst) '5.4.2010
                                    objDataRow.Item(ConstObservation) = gfuncWordWrap(CStr(mobjTmpDt.Rows.Item(intCount).Item("OQObservation")), intCharConst) '5.4.2010
                        ...
                        If Not mobjTmpDt Is Nothing Then
                            If Not mobjTmpDt.Rows.Count = 0 Then
                                For intCount = 0 To mobjTmpDt.Rows.Count - 1
                                    ...
                                    objDataRow.Item(ConstTestName) = gfuncWordWrap(CStr(mobjTmpDt.Rows.Item(intCount).Item("OQTestName")), intCharConst)
                                    objDataRow.Item(ConstObservation) = gfuncWordWrap(CStr(mobjTmpDt.Rows.Item(intCount).Item("OQObservation")), intCharConst)
                                    objDataRow.Item(ConstDemoDate) = CStr(mobjTmpDt.Rows.Item(intCount).Item("OQDemoDate"))
                                    objDataRow.Item(ConstVerifiedDate) = CStr(mobjTmpDt.Rows.Item(intCount).Item("OQVerifiedDate"))
                                    objDataRow.Item(ConstTestID) = testID
    ...
    Private Sub subFormatDataGrid(ByRef objGridTableStyle As DataGridTableStyle, ByRef dg As DataGrid, ByVal objDataTable As DataTable)
        ...
        Try
            ...
            '----------------------------------'5.4.2010
            If dg.Name = "dgTest2" Then
                objGridTableStyle.PreferredRowHeight = 49
            ElseIf dg.Name = "dgTest1" Then
    ...
    Public Function funcSaveOQTest1Data(ByVal testnos As Integer) As Boolean
        '=====================================================================
...
#End Region
    ...
    Private Sub dgTest1_CurrentCellChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgTest1.CurrentCellChanged
        ...
        Try
            ...
            '------------------------------------------------------------------------
        Catch ex As Exception
            mblnAvoidProcessing = False '27.6.2010 by dinesh wagh on 29.6.2010
            gobjErrorHandler.ErrorDescription = ex.Message
            gobjErrorHandler.ErrorMessage = ex.Message
            gobjErrorHandler.WriteErrorLog(ex)
        Finally
    ...
    Private Sub dgTest2_CurrentCellChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgTest2.CurrentCellChanged
        ...
        Try
            ...
            '------------------------------------------------------------------------
        Catch ex As Exception
            mblnAvoidProcessing = False '29.6.2010
            gobjErrorHandler.ErrorDescription = ex.Message
            gobjErrorHandler.ErrorMessage = ex.Message
            gobjErrorHandler.WriteErrorLog(ex)
        Finally
