...
public class frmPQTest7 : System.Windows.Forms.Form
{
	...
	{
		System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmPQTest7));
		...
		this.lblAttachment.Text = "Attachment VI";
		//
		//lblMethod
		//
		...
		this.lblMethod.Text = "Method            :  Thermal Conductivity detector with Single and Dual Packed an" + "d without MFC Column system :";
		//
		//lblPurpose
		//
...
frmPQTest2_Closing(object sender, System.ComponentModel.CancelEventArgs e)
	...
	private bool funcDisplayPQTest1()
	{
		...
		try {
			...
			mobjTmpDt = gobjDataAccess.funcGetPQTest6Records();
	...
	public bool funcSavePQTest1Remarks()
	{
		...
		try {
			...
			for (temp_cnt = 0; temp_cnt <= objDataTable.Rows.Count - 1; temp_cnt++) {
				...
				status = gobjDataAccess.funcUpdatePQTest6Records(dblRT, dblPeakArea, strValidationTestID);
				if (!(status)) {
	...
	private void subDisplayMethodInfo()
	{
		...
		try {
			...
			objDataRow = objCADataTable.NewRow();
			objDataRow("Name") = "1. Column           : 5 % SE-30 S.S.Column size 8'x1/8'' OD,80/100 Mesh.";
			objCADataTable.Rows.Add(objDataRow);

			objDataRow = objCADataTable.NewRow();
			objDataRow("Name") = "2. Carrier Gas      : Hydrogen.";
			objCADataTable.Rows.Add(objDataRow);

			objDataRow = objCADataTable.NewRow();
			objDataRow("Name") = "3. Flow Rate        : H2 - 30 ml/min.";
			objCADataTable.Rows.Add(objDataRow);

			objDataRow = objCADataTable.NewRow();
			objDataRow("Name") = "4. Detector         : TCD.";
			objCADataTable.Rows.Add(objDataRow);
			...
			objDataRow = objCADataTable.NewRow();
			objDataRow("Name") = "6. Temperature      : Oven-80 �C., Injector-150 �C., Detector-200 �C.";
			objCADataTable.Rows.Add(objDataRow);

			objDataRow = objCADataTable.NewRow();
			objDataRow("Name") = "7. Range            : 1.";
			objCADataTable.Rows.Add(objDataRow);
			...
			objDataRow = objCADataTable.NewRow();
			objDataRow("Name") = "9. TCD Current      : 200 mA.";
			objCADataTable.Rows.Add(objDataRow);
