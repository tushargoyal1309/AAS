...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmPQTest5))
        ...
        Me.lblAttachment.Text = "Attachment IV"
        '
        'lblMethod
        '
        ...
        Me.lblMethod.Text = "Method            :  Flame ionization detector with Capillary Column system :"
        '
        'lblPurpose
        '
        ...
        Me.Panel1.Size = New System.Drawing.Size(310, 510)
        ...
        Me.Panel2.Size = New System.Drawing.Size(308, 32)
        ...
        Me.ClientSize = New System.Drawing.Size(310, 424)
        Me.ControlBox = False
...
#Region " General Private functions "
    ...
    Private Function funcDisplayPQTest1() As Boolean
        ...
        Try
            ...
            mobjTmpDt = gobjDataAccess.funcGetPQTest4Records()
    ...
    Public Function funcSavePQTest1Remarks() As Boolean
        ...
        Dim strComments, strValidationTestID As String
        ...
        Try
            ...
            For temp_cnt = 0 To objDataTable.Rows.Count - 1
                ...
                status = gobjDataAccess.funcUpdatePQTest4Records(dblRT, dblPeakArea, strValidationTestID)
                If Not (status) Then
    ...
    Private Sub subDisplayMethodInfo()
        ...
        Try
            ...
            objDataRow = objCADataTable.NewRow()
            objDataRow("Name") = "1. Column           : 12 mtr.x 0.53 mm ld BP-1 or any suitable capillary column."
            objCADataTable.Rows.Add(objDataRow)

            objDataRow = objCADataTable.NewRow()
            objDataRow("Name") = "2. Carrier Gas      : Nitrogen or as recommended by the column supplier."
            objCADataTable.Rows.Add(objDataRow)

            objDataRow = objCADataTable.NewRow()
            objDataRow("Name") = "3. Flow Rate        : N2 - 10 ml/min, H2 - 30 ml/min, AIR -- 300 ml/min."
            objCADataTable.Rows.Add(objDataRow)
            ...
            objDataRow = objCADataTable.NewRow()
            objDataRow("Name") = "5. Injection Volume : 0.5 Micro-liter with split ratio."
            objCADataTable.Rows.Add(objDataRow)

            objDataRow = objCADataTable.NewRow()
            objDataRow("Name") = "6. Split ratio      : 1:5 (Split vent flow: 50 ml/min)."
            objCADataTable.Rows.Add(objDataRow)

            objDataRow = objCADataTable.NewRow()
            objDataRow("Name") = "7. Temperature      : Oven-80 °C., Injector-150 °C., Detector-180 °C."
            objCADataTable.Rows.Add(objDataRow)

            objDataRow = objCADataTable.NewRow()
            objDataRow("Name") = "8. Range            : 1000 or 10^2."
            objCADataTable.Rows.Add(objDataRow)

            objDataRow = objCADataTable.NewRow()
            objDataRow("Name") = "9. Attenuation      : 512."
            objCADataTable.Rows.Add(objDataRow)
